<?php
	...
	/*
		This function is used to determine if PhantomJS is installed and readily accessible
		via PATH.

		If PhantomJS is found, then it will return "true". If it is not found, then it will
		return false.
	...
	*/
	if(!function_exists("phantomjs_verify_install"))
	{
		function phantomjs_verify_install($path) :bool
		{
			/*
			...
			*/
			...
			/*
				Evaluate to determine how to check for the availability of PhantomJS.
